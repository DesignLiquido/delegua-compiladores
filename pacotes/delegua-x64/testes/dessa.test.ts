import { Alocacao } from '../fontes/x64/alocador-registradores';
import { destruirSSA } from '../fontes/x64/dessa';
import { IRFuncao, IRValor, novoBloco, novaFuncao, valorConstante, valorRegistrador } from '../fontes/x64/ir';
