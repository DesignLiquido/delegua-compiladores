import { alocarRegistradores } from '../fontes/x64/alocador-registradores';
import { IRFuncao, novoBloco, novaFuncao, valorConstante, valorRegistrador } from '../fontes/x64/ir';
