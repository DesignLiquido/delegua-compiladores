import { AcessoIndiceVariavel, AcessoMetodo, Agrupamento, Atribuir, AtribuicaoPorIndice, Binario, Chamada, DefinirValor, FuncaoConstruto, Leia, Literal, Logico, TipoDe, Unario, Variavel, Vetor, Bloco, Classe, Const, Declaracao, Enquanto, Escolha, Escreva, Expressao, Falhar, Fazer, FuncaoDeclaracao, Importar, Para, ParaCada, Retorna, Se, Tente, Var, CaminhoEscolha, SimboloInterface, Simbolo } from "@designliquido/delegua";
import { TradutorAssemblyARM } from "../fontes/tradutor-assembly-arm";
